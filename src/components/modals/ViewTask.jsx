...
function ViewTasks(props) {
    ...
    const handleClickDoItNow = () => {
        setCurrCard(c => ({...c, status: "Started", date_updated: new Date()}));
        setIsChanged(true);
    }
                ...
                <div className="container">
                    ...
                    <div className="modal-container">
                        <section className="dates">
                            {currCard && currCard.status == "Completed" ? <><h4>Completed on {currCard && displayDate(currCard.due_date)}</h4></>
                            ...
                            <div className="dates-other">
                                ...
                                <p style={currCard && completed()}>Updated last {currCard && displayDate(currCard.date_updated)}</p>
                            </div>
                        </section>
                        ...
                        <div className="check-important" style={currCard && notAuthor()}>
                            <select defaultValue={currCard && currCard.tag} style={currCard && completed()} onChange={e => setCurrCard(c => ({...c, tag: e.target.value, date_updated: new Date()}))}>
                        ...
                        <div className="select-date" style={currCard && completed()}>
                        ...
                        <section className="select-button" style={currCard && completed()}>
                            ...
                            {currCard && currCard.assignee ===  props.USER_INFO.id  ? <button className="do-it-now" onClick={handleClickDoItNow}>DO IT NOW</button>
                                                                                    : <></>}
                        </section>
                    </div>
                </div>
